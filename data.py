...
TEXT = {
        ...
        'auth_start_log': '[AUTH] Starting auth setup',
        'auth_start_promt': 'Unable to find "auth.json" file, start authorization on Twitch?',
        'auth_channel_promt': 'Enter name of channel where simulator will be used (only nickname, not link to channel): ',
        'auth_channel_error_name': 'Channel name contains invalid characters!',
        'auth_channel_separ': 'Will we use one account for chat-bot and channel points?',
        ...
        'auth_browser_promt': 'Now a new tab will be opened in standard web browser\nThis will request access to bot\'s account\nMake sure to check following:\n\n- address in address bar should be: "id.twitch.tv"\n- application name: "Genshin Wish Simulator"\n- on page must be nickname of account that you want to use as bot\n\n>>> Now we are setting up an account for: %s <<<',
        'auth_browser_close': 'Confirm access in web browser window that opens and ONLY then press OK button',
        'auth_gate_error': 'Failed to query gate for a token!',
        'auth_token_error': 'Failed to create token. The reason was stated in browser window after logging in',
        'auth_create_success': 'All went fine, account is set up',
        'auth_end': 'Account data is stored in "auth.json"\nDo not pass this file on to anyone and do not show its contents on stream!\nTo start setting up accounts again, simply delete "auth.json" from simulator folder',
        'auth_force_test': 'No auth data found, enabled test mode',
        'ui_update_title': 'Update',
        'ui_update_message': 'Update available, visit GitHub page to download!',
        'ui_update_message_version': 'Current version: %s, available version: %s',
        'ui_twitch_auth': 'Authorization',
        'ui_yes': 'Yes',
        'ui_no': 'No',
        'ui_error': 'Error',
        'ui_info': 'Information',
