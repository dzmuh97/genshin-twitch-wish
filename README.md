...
Возможности:
 ...
 - Настройка времени и показа стадий анимации (показ ника зрителя, анимация падения, анимация результат молитвы)
...
## Описание `config.json`
 ...
 - **event_bot** - секция для настройки баллов канала
   ...
   - **work_channel_id** - ID канала на котором будут использоваться награды [^1]
...
[^1]: Узнать свой ID канала можно тут: https://www.streamweasels.com/tools/convert-twitch-username-to-user-id/
