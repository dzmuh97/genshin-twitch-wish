...
Возможности:
 ...
 - Рендер истории молитв зрителей в `HTML`
...
В симуляторе используется 2 вида бота: чат-бот, который читает сообщения из чата (секция **chat_bot**), и бот, который ждет использование баллов канала (секция **event_bot**). Так как эти боты работают раздельно друг от друга, возможны 2 варианта настройки:
